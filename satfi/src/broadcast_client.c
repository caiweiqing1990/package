...
route add -net 224.0.0.88 netmask 255.255.255.255 br-lan2
route del -net 224.0.0.88 netmask 255.255.255.255 br-lan2
*/
...
int main(int argc, char*argv[])
{
	...
	for(times = 0; 1; times++)
	{
		...
		/*打印信息*/
		printf("Recv %dst    message from server:%s %s %d\n", times, buff, inet_ntoa(local_addr.sin_addr), ntohs(local_addr.sin_port));
